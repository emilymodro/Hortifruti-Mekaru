    ...
    <div class="card-body">
        <form action="processa_cliente.php" method="POST">
            ...
            <fieldset class="mb-4 p-3 border rounded">
                <legend class="float-none w-auto px-1 h6 text-primary">Dados Primários</legend>
                <div class="row mb-3">
                    <div class="col-md-6">
            ...
            <fieldset class="mb-4 p-3 border rounded">
                <legend class="float-none w-auto px-1 h6 text-primary">Endereço</legend>
                <div class="row">
                    <div class="col-12">
            ...
            <fieldset class="mb-4 p-3 border rounded">
                <legend class="float-none w-auto px-1 h6 text-primary">Contatos (Telefones, E-mails Adicionais)</legend>
                <div id="contatos_area">
                    <div class="row mb-2 contato-item">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <button type="button" class="btn btn-danger btn-sm remover-contato d-none">Remover</button>
                        </div>
                    </div>
                </div>
            ...
            <fieldset class="mb-4 p-3 border rounded">
                <legend class="float-none w-auto px-1 h6 text-primary">Chaves PIX</legend>
                <div id="pix_area">
                    <div class="row mb-2 pix-item">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                             <button type="button" class="btn btn-danger btn-sm remover-pix d-none">Remover</button>
                        </div>
                    </div>
                </div>
